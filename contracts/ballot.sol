...
contract Ballot {
     ...
     */
    constructor(string[] memory proposalNames, uint _delay, Edu_Token _token) {
    ...
    function vote(uint proposal) public {
        ...
        require(block.timestamp <= timeout, "Vote time out");
        sender.voted = true;
    ...
    function addProposal(string memory _proposal) public payable {
        proposals.push(Proposal({
                name: _proposal,
                voteCount: 0
            }));
